...
const PossibleAtrsForGermanHealthCards = ["3bd096ff81b1fe451f032e", "3bd096ff81b1fe451f072a", "3bd096ff81b1fe451fc7ea", "3bd097ff81b1fe451f072b"];
...
class eGKReader extends EventEmitter {
     ...
     * The card type is automatic selected by the ATR (https://smartcard-atr.apdu.fr/)
     * @param {Buffer} atr 
     * @returns {JSON}
     */
    async getInsurantData(atr) {
        if (PossibleAtrsForGermanHealthCards.includes(atr.toString("hex")))
            return await this.getInsurantDataDE();
        else if (PossibleAtrsForAustrianHealthCards.includes(atr.toString("hex")))
            return await this.getInsurantDataAT();
    ...
    async getInsurantDataAT() {
        ...
        const personalData = {
            cardtype: "ecard",
            insuredid: readInsurantDataFromASN1(data, "1.2.40.0.10.1.4.1.1"),
            dob: formatDateOfBirth(readInsurantDataFromASN1(data, "dateOfBirth")),
            forename: readInsurantDataFromASN1(data, "givenName"),
            surname: readInsurantDataFromASN1(data, "surname"),
    ...
    async getInsurantDataDE() {
        ...
        const personalData = {
            cardtype: "egk",
            insuredid: parsedXML.UC_PersoenlicheVersichertendatenXML.Versicherter.Versicherten_ID,
            dob: parsedXML.UC_PersoenlicheVersichertendatenXML.Versicherter.Person.Geburtsdatum,
            forename: parsedXML.UC_PersoenlicheVersichertendatenXML.Versicherter.Person.Vorname,
            surname: parsedXML.UC_PersoenlicheVersichertendatenXML.Versicherter.Person.Nachname,
            ...
            housenr: parsedXML.UC_PersoenlicheVersichertendatenXML.Versicherter.Person.StrassenAdresse.Hausnummer,
            ...
            land: parsedXML.UC_PersoenlicheVersichertendatenXML.Versicherter.Person.StrassenAdresse.Wohnsitzlaendercode
        }
